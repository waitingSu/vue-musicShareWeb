...
import usePlayerStroe from '@/stores/player';
...
export default {
  ...
  data() {
    return {
      ...
      comment_alert_message: 'Please wait! Your comment is being submiutted',
      comments: [],
      sort: '1',
    };
  },
  computed: {
    ...
    ...mapState(usePlayerStroe, ['playing']),
    sortedComments() {
  ...
  methods: {
    ...mapActions(usePlayerStroe, ['newSong']),
    async addComment(values, { restForm }) {
      this.comment_in_submission = true;
      this.comment_show_alert = true;
      this.comment_alert_variant = 'bg-blue-500';
      this.comment_alert_message = 'Please wait! Your comment is being submiutted';
